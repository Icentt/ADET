...
class _LostPageState extends State<LostPage> {
  ...
  List<Map<String, dynamic>> _filteredLostItems = [];
  ...
  Future<void> _loadLostItems() async {
    try {
      ...
      print('🔹 Loading approved lost items...');
      ...
      print('🔹 Lost items loaded: ${response.length}');

      setState(() {
        _lostItems = List<Map<String, dynamic>>.from(response);
        _filteredLostItems = _lostItems;
        _isLoading = false;
      });
    } catch (e) {
      setState(() {
        _errorMessage = 'Failed to load lost items: ${e.toString()}';
        _isLoading = false;
      });
  ...
  void _filterItems() {
    ...
    setState(() {
      if (query.isEmpty) {
        ...
        _filteredLostItems = _lostItems.where((item) {
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    _buildDesktopNavItem("Lost", isActive: true),
  ...
  Widget _buildContent() {
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              _searchController.text.isEmpty
                  ? 'Approved lost items will appear here.\nCheck back later!'
    ...
    return GridView.builder(
      ...
      itemCount: _filteredLostItems.length,
      itemBuilder: (context, index) {
        return _buildItemCard(_filteredLostItems[index]);
      },
    );
  }
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text('Date Lost: ${item['date'] ?? 'Unknown'}'),
              const SizedBox(height: 16),
              const Text(
                'Contact Information:',
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _buildNavItem(Icons.search, "Lost", isActive: true),
  ...
  Widget _buildDesktopContent() {
    ...
    return GridView.builder(
      ...
      itemCount: _filteredLostItems.length,
      itemBuilder: (context, index) {
        return _buildDesktopItemCard(_filteredLostItems[index]);
      },
    );
  }
